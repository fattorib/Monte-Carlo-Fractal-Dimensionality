...
This code will estimate the fractal dimension of the Sierpinski triangle using Monte-Carlo
...
plot = plt.imread('sierpinski.png')
#plt.imshow(plot)
size = len(plot[0])
...
plt.plot(real_dimension, 'r--', label = 'Dimension (d = 1.5849)')
plt.title('Number of iterations vs. esitmated dimension (Sierpinski Triangle)')
